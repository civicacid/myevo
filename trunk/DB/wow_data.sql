...
insert into maillist (server,sender_char_name,item_name,receiver_char_name) values ('爱斯特纳','ALL','狂热暗烬黄玉',     '收矿啊');
insert into maillist (server,sender_char_name,item_name,receiver_char_name) values ('爱斯特纳','ALL','精锐暗烬黄玉',     '收矿啊');
...
insert into charcreation (char_name,tradeskill,item_name,need_item_name1) values ('Welcomex',1,  '狂热暗烬黄玉'  ,   '暗烬黄玉');
insert into charcreation (char_name,tradeskill,item_name,need_item_name1) values ('Welcomex',1,  '精锐暗烬黄玉'  ,   '暗烬黄玉');
...
insert into wowaccount(acc_id,acc_name,acc_pass,status) values(seq_all.nextval,'skeyolop@sina.com','d3d!dd3!@',1);
insert into wowaccount(acc_id,acc_name,acc_pass,status) values(seq_all.nextval,'watkeep@sina.com','jd8qd2*!tt',1);
insert into wowaccount(acc_id,acc_name,acc_pass,status) values(seq_all.nextval,'highlightli@sina.com','d2d2!!kk#iiq',1);
insert into wowaccount(acc_id,acc_name,acc_pass,status) values(seq_all.nextval,'ff17yho@sina.cn','ff117power',1);
...
insert into wowchar(acc_id,char_id,char_name,server,acc_list,char_idx) values ((select acc_id from wowaccount where acc_name = 'nnoky123@gmail.com'),seq_all.nextval,'铭文学专家二','爱斯特纳','',1);
insert into wowchar(acc_id,char_id,char_name,server,acc_list,char_idx) values ((select acc_id from wowaccount where acc_name = 'nnoky123@gmail.com'),seq_all.nextval,'铭文学专家三','爱斯特纳','',2);
insert into wowchar(acc_id,char_id,char_name,server,acc_list,char_idx) values ((select acc_id from wowaccount where acc_name = 'nnoky123@gmail.com'),seq_all.nextval,'铭文学专家四','爱斯特纳','',3);
...
insert into wowchar(acc_id,char_id,char_name,server,acc_list,char_idx) values ((select acc_id from wowaccount where acc_name = 'skeyolop@sina.com'),seq_all.nextval,'籢扜捳汨浡数','破碎岭','',0);
insert into wowchar(acc_id,char_id,char_name,server,acc_list,char_idx) values ((select acc_id from wowaccount where acc_name = 'watkeep@sina.com'),seq_all.nextval,'湩瑹瑩屳籢潣','破碎岭','',0);
insert into wowchar(acc_id,char_id,char_name,server,acc_list,char_idx) values ((select acc_id from wowaccount where acc_name = 'highlightli@sina.com'),seq_all.nextval,'屬籢扜敦獲湯','破碎岭','',0);
insert into wowchar(acc_id,char_id,char_name,server,acc_list,char_idx) values ((select acc_id from wowaccount where acc_name = 'ff17yho@sina.cn'),seq_all.nextval,'籢扜牣捡屫','破碎岭','',0);
-----------------------------------------------------------------------------------------------------------------------------------
...
/**********************************/
/***********    炼金制作清单     *************/
insert into char_lianjin (server,char_name,skill,lianjin_itemname,do_order,dischant,mail) values ('爱斯特纳','爱贝贝熊','LJ','转化：地狱炎石',1,0,1);
