...
namespace LazyEvo.Forms
{
    internal partial class Setup : Office2007Form
    {
        ...
        private void Form1Load(object sender, EventArgs e)
        {
            ...
            string _ourDirectory = executableFileInfo.DirectoryName;
            if (Directory.Exists(_ourDirectory + "\\Behaviors"))
            {
                txtFight.Items.Clear();
                string[] files = Directory.GetFiles(_ourDirectory + "\\Behaviors", "*xml");
                foreach (string file in files)
                {
                    txtFight.Items.Add(Path.GetFileNameWithoutExtension(file));
                }
            } 
            LoadSettings();
            HideAgain();
        ...
        public void LoadSettings()
        {
            ...
            //add by spyman
            txtWOWPath.Text = LazySettings.WOWPath;
            txtUser.Text = LazySettings.WOWAccName;
            txtPass.Text = LazySettings.WOWAccPass;
            txtCharList.Text = LazySettings.WOWCharList; 
            txtCharIdx.Text = LazySettings.WOWCharIdx;
            txtServer.Text = LazySettings.WOWServer;
            txtStartHour.Text = LazySettings.StartHour;
            txtStartMin.Text = LazySettings.StartMin;
            txtEndHour.Text = LazySettings.StopHour;
            txtEndMin.Text = LazySettings.StopMin;
        ...
        public void SaveSettings()
        {
            ...
            //WOW Path
            LazySettings.WOWPath = txtWOWPath.Text;
            LazySettings.WOWAccName = txtUser.Text;
            LazySettings.WOWAccPass = txtPass.Text;
            LazySettings.WOWCharList = txtCharList.Text;
            LazySettings.WOWCharIdx = txtCharIdx.Text;
            LazySettings.WOWServer = txtServer.Text;
            LazySettings.StartHour = txtStartHour.Text;
