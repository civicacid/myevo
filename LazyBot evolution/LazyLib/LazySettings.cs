...
namespace LazyLib
{
    ...
    public class LazySettings
    {
        ...
        public static string WOWAccName;
        public static string WOWAccPass;
        public static string WOWCharList;
        public static string WOWCharIdx;
        public static string WOWServer;
        public static string StartHour;
        public static string StartMin;
        public static string StopHour;
