...
local MAJOR, MINOR = "LibBossIDs-1.0", "$Revision: 27 $"
...
local BossIDs = {
	...
	-- not found ["Overseer Tidewrath"] = true, --"Overseer Tidewrath", -- Was removed from game
	...
	[33993] = true, --"Emalon the Storm Watcher", -- Wintergrasp 3.1 PVP boss
	...
	[34445] = true,-- PTR 3.2 Raid: FactionChampions: Liandra Suncaller	paladin, horde
	[34447] = true,-- PTR 3.2 Raid: FactionChampions: Caiphus the Stern	priest,horde
	[34448] = true,-- PTR 3.2 Raid: FactionChampions: Ruj'kah	hunter,horde
	[34449] = true,-- PTR 3.2 Raid: FactionChampions: Ginselle Blightslinger	mage, horde
	[34450] = true,-- PTR 3.2 Raid: FactionChampions: Harkzog	warlock,horde
	[34451] = true,-- PTR 3.2 Raid: FactionChampions: Birana Stormhoof	druid,horde
	[34453] = true,-- PTR 3.2 Raid: FactionChampions: Narrhok Steelbreaker	warrior, horde
	[34454] = true,-- PTR 3.2 Raid: FactionChampions: Maz'dinah	rogue, horde
	[34455] = true,-- PTR 3.2 Raid: FactionChampions: Broln Stouthorn	shaman, horde
	...
	[34463] = true,-- PTR 3.2 Raid: FactionChampions: Shaabad	shaman, alliance
	[34465] = true, --PTR 3.2 Raid: FactionChampions: Velanaa	paladin, alliance- confirmed
	[34466] = true, --PTR 3.2 Raid: FactionChampions: Anthar Forgemender	priest, alliance- confirmed
	[34467] = true, --PTR 3.2 Raid: FactionChampions: Alyssia Moonstalker	hunter, alliance- confirmed
	[34468] = true, --PTR 3.2 Raid: FactionChampions: Noozle Whizzlestick	mage, alliance- confirmed´
	[34469] = true, --PTR 3.2 Raid: FactionChampions: Melador Valestrider	druid, alliance
	[34470] = true, --PTR 3.2 Raid: FactionChampions: Saamul	shaman, alliance- confirmed 
	[34471] = true, --PTR 3.2 Raid: FactionChampions: Baelnor Lightbearer	paladin, alliance
	[34472] = true, --PTR 3.2 Raid: FactionChampions: Irieth Shadowstep	rogue, alliance- confirmed
	[34473] = true, --PTR 3.2 Raid: FactionChampions: Brienna Nightfell	priest, alliance
	[34474] = true, --PTR 3.2 Raid: FactionChampions: Serissa Grimdabbler	warlock, alliance- confirmed
	[34475] = true, --PTR 3.2 Raid: FactionChampions: Shocuul	warrior, alliance- confirmed
	[35465] = true, --PTR 3.2 Raid: FactionChampions: Zhaagrym (Warlock-Pet)
	--
